            ...
            {sidebarOpen && (
              <div className="px-4 mt-5">
                <div className="relative">
                  ...
                  >
                    <span className="block truncate">{activeOrganization.name}</span>
                ...
                <p className="mt-1 text-xs text-gray-500">{activeOrganization.role}</p>
              </div>
            )}
                ...
                <Link
                  ...
                  className={`${
                    router.pathname === item.href
                      ...
                      : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                  } group flex items-center px-2 py-2 text-sm font-medium rounded-md ${sidebarOpen ? '' : 'justify-center'}`}
                >
                  <item.icon />
